    ...
    try {
      ...
      try {
        ...
        if (userData.role !== 'nurse') {
          setError('Access denied. Only nurses can login here.');
          setLoading(false);
          return;
        }
      } catch (apiError) {
        ...
        const testNurses = [
          { email: 'nurse@test.com', password: 'password123' },
          { email: 'sarah@example.com', password: 'password123' }
        ];
        
        const foundTestUser = testNurses.find(
        ...
        // For testing purposes, create a mock nurse user
        userData = {
          id: 1,
          email: formData.email,
          role: 'nurse'
              ...
              <div className="auth-card">
                <div className="auth-header">
                  ...
                  <p className="text-muted">
                    Access your nursing dashboard to manage patient care
                  </p>
                </div>
                ...
                {!isServerAvailable && (
                  <div className="alert alert-warning mb-4" role="alert">
                    ...
                    <div className="mt-2">
                      <strong>Test Nurse Login:</strong> 
                      <ul>
                        <li>Email: nurse@test.com</li>
                ...
                <div className="auth-footer">
                  <p>
                    <Link to="/nurse/forgot-password" className="btn btn-link p-0">Forgot Password?</Link>
                  </p>
                  <p className="mt-3 text-muted small">
                    Note: Only authorized nursing staff can access this portal. If you're experiencing issues logging in,
