...
const Navbar: React.FC<NavbarProps> = ({ isDashboard = false }) => {
  ...
  // Check if we're in a dashboard or protected area
  const inDashboard = isDashboard || 
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: '#3a7ca5' }}>
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="https://tdtu.edu.vn/" target="_blank" rel="noopener noreferrer">About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://tdtu.edu.vn/" target="_blank" rel="noopener noreferrer">Services</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://tdtu.edu.vn/" target="_blank" rel="noopener noreferrer">Contact</a>
            </li>
          </ul>
        </div>
      </div>
